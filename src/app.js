// ==========================================================================
// 1. Cart Management State & Logic (Non-Module Vanilla JS)
// ==========================================================================
...
// ==========================================================================
// 2. Rendering, Router & Events (Merged main.js logic)
// ==========================================================================
...
function renderCartPage() {
  ...
  appRoot.innerHTML = `
    ...
    <div class="cart-layout">
      ...
      <div class="summary-card" id="bill-summary-container"></div>
    </div>
  `;
...
function renderBillSummary() {
  ...
  if (appliedPromo) {
    if (appliedPromo.code === 'VELOCE20') {
      promoDiscountVal = totals.currentPriceTotal * 0.20;
      promoRowHTML = `
